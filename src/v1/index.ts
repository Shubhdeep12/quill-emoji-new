import { createEmojiBlotV1 } from "../blots/emoji-blot-v1";
...
export function registerQuillEmojiV1(Quill: QuillLike, options: RegisterEmojiOptions = {}): void {
  const EmojiBlot = createEmojiBlotV1(Quill, {
...
if (maybeGlobalQuill) {
  registerQuillEmojiV1(maybeGlobalQuill);
}
